...
def run_training(script_name, config_name, cudnn_benchmark=True, local_rank=-1, save_dir=None, base_seed=None,
    ...
    if distill:
        ...
        expr_module = importlib.import_module('lib.train.train_umatrack')
...
def main():
    ...
    parser.add_argument('--script', default='umatrack', type=str,  help='Name of the train script.')
    parser.add_argument('--config', default='baseline', type=str, help="Name of the config file.")
    parser.add_argument('--cudnn_benchmark', type=bool, default=True, help='Set cudnn benchmark on (1) or off (0) (default is on).')
    parser.add_argument('--local_rank', default=-1, type=int, help='node rank for distributed training')
    parser.add_argument('--save_dir', default='../../checkpoint', type=str, help='the directory to save checkpoints and logs')
    ...
    # args.stage1_model = '/home/lw/lw/code/mixformer_light_2/checkpoint/checkpoints/train/fusiontrans_light/baseline/MixFormer_ep0480.pth.tar'
